    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.event_note), label: "기록"),
    ...
    return Container(
      ...
      Positioned.fill(
        ...
        Container(
            child: Column(
              children: [
                Text(todayDiary.title == "" ? "일기를 작성하세요" : todayDiary.title,
                    style:
                  ...
                  children: List.generate(statusImages.length, (ridx) {
                    return Container(
                      child: Column(children: [
                        ...
                        Text(
                            "${allDiaries.where((element) => element.status == ridx).length}개"),
                      ]),
                    );
                  })));
        } else if (idx == 1) {
